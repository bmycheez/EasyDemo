...
pipeline = [
    ...
    dict(type='GatePressKeyWrapper',
         ...
         transforms=[
             dict(type='TRTModelWrapper', load_from='weights/rgb2rgb-trt-2dnr/Unet3to3-4ch_alpha-0.4.blob'),
             dict(type='TRTModelWrapper', load_from='weights/rgb2rgb-trt-2dnr/Unet3to3-4ch_alpha-0.8.blob'),
             dict(type='TRTModelWrapper', load_from='weights/rgb2rgb-trt-2dnr/Unet3to3-4ch_alpha-1.2.blob'),
             dict(type='TRTModelWrapper', load_from='weights/rgb2rgb-trt-2dnr/Unet3to3-4ch_alpha-1.6.blob')]),
    # Postprocessing
